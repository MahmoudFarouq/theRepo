var AVL = function () 
{
    ...
    this.StartingPos = createVector(screen.width/2, 150);
    ...
    this.setNewNodePos = function(parent){
        if(parent.right !== null)
        {
            h = this.DisFromRoot(parent.right.value);
            parent.right.setPos(createVector(parent.newPos.x+this.x/(h-1)-50, parent.newPos.y+80));
            this.setNewNodePos(parent.right);
        }
        if(parent.left !== null)
        {
            h = this.DisFromRoot(parent.left.value);
            parent.left.setPos(createVector(parent.newPos.x-this.x/(h-1)+50, parent.newPos.y+80));
            this.setNewNodePos(parent.left);
        }
    }
    ...
    this.insert = function (value){
        ...
        this._root.setPos(this.StartingPos);
        this.setNewNodePos(this._root);
    };
    ...
    this.DisFromRoot = function (value){
        counter = 1;
        temp = this._root;
